translations["en"] = {
	...
	GIFT_RECV = "<N>Ap ko <ROSE><b>${admin}</b></ROSE> ne <ROSE><b>${gift}</b></ROSE> inaam kiya hai",
	COMMANDS =  "\n\n<N2>[ <b>H</b> ]</N2> <N><ROSE>!help</ROSE> (help menu dikhaye ga)</N><br><N2>[ <b>P</b> ]</N2> <N><ROSE>!profile <i>[player]</i></ROSE> (Player ki profile dikhaye ga)</N><br></N><N2>[ <b>O</b> ]</N2> <N><ROSE>!shop</ROSE> (dukaan kholay ga)</N><br><N2>[ <b>L</b> ]</N2> <N>(leaderboard kholay ga)</N><br><br><N><ROSE>!changelog</ROSE> (changelog dikhaye ga)</N><br><br>",
